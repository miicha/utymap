...
BOOST_AUTO_TEST_CASE(GivenNaturalEarthTestData_WhenAllQuadKeysAreLoadedAtZoomOne_ThenCallbacksAreCalled) {
  ::addDataInRange(InMemoryStoreKey, NaturalEarthMapcss, TEST_SHAPE_NE_110M_LAND, 1, 1, callback);
  ::addDataInRange(InMemoryStoreKey, NaturalEarthMapcss, TEST_SHAPE_NE_110M_RIVERS, 1, 1, callback);
  ::addDataInRange(InMemoryStoreKey, NaturalEarthMapcss, TEST_SHAPE_NE_110M_LAKES, 1, 1, callback);
  ...
  ::addDataInRange(InMemoryStoreKey, NaturalEarthMapcss, TEST_SHAPE_NE_110M_POPULATED_PLACES, 1, 1, callback);
...
BOOST_AUTO_TEST_CASE(GivenTestData_WhenQuadKeysAreLoadedAtBirdEyeZoomLevel_ThenCallbacksAreCalled) {
  ::addDataInQuadKey(InMemoryStoreKey, TEST_MAPCSS_DEFAULT, TEST_JSON_2_FILE, 8800, 5373, 14, callback);
...
BOOST_AUTO_TEST_CASE(GivenTestData_WhenDataIsLoadedInLodRangeAtDetailedZoom_ThenCallbacksAreCalled) {
  ::addDataInRange(InMemoryStoreKey, TEST_MAPCSS_DEFAULT, TEST_XML_FILE, 16, 16, callback);
...
BOOST_AUTO_TEST_CASE(GivenTestData_WhenQuadKeysAreLoadedInSequenceAtDetailedZoom_ThenCallbacksAreCalled) {
  ::addDataInQuadKey(InMemoryStoreKey, TEST_MAPCSS_DEFAULT, TEST_XML_FILE, 35205, 21489, 16, callback);
  loadQuadKeys(16, 35205, 35205, 21489, 21489);

  ::addDataInQuadKey(InMemoryStoreKey, TEST_MAPCSS_DEFAULT, TEST_XML_FILE, 35204, 21490, 16, callback);
...
BOOST_AUTO_TEST_CASE(GivenTestData_WhenQuadKeyIsLoaded_ThenSearchFindsRelation) {
  ...
  isCalled = false;
  utymap::CancellationToken cancelToken;
  ::addDataInRange(InMemoryStoreKey, TEST_MAPCSS_DEFAULT, TEST_JSON_FILE, lod, lod, callback);
