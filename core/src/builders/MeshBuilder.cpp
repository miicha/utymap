...
namespace
{
    ...
    std::function<Vector2(double, double)> createMapFunc(const MeshBuilder::AppearanceOptions& appearanceOptions, const BoundingBox& bbox)
    {
...
void MeshBuilder::addTriangle(Mesh& mesh, const Vector3& v0, const Vector3& v1, const Vector3& v2,
                              ...
                              const GeometryOptions& geometryOptions, const AppearanceOptions& appearanceOptions) const
{
    auto color = appearanceOptions.gradient.evaluate((NoiseUtils::perlin2D(v0.x, v0.z, appearanceOptions.colorNoiseFreq) + 1) / 2);
